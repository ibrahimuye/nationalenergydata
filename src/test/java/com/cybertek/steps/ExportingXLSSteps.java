...
//        inputStream.close();
        ...
        boolean exist = false;
        for (int i = 5; i <= 55; i++) {
//            if (getCellData(i,0).equals(string)){exist=true;  break;}
...
//        System.out.println(exist);
    ...
    public String user_records_the_most_energy_consuming_state_in_transportation() {
        ...
        for (int i = 5; i <= 55; i++) {
//
            if (Double.valueOf(workSheet.getRow(i).getCell(1).toString())> max) {  max= Double.valueOf(workSheet.getRow(i).getCell(1).toString());
                country= workSheet.getRow(i).getCell(0).toString();
            }
